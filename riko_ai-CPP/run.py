...
GUI_SOURCE  = os.path.join(PROJECT_DIR, "gui.cpp")
...
def compile_gui():
    ...
    try:
        ...
        cmd = ["g++", "-O2", "-Wall", "-Wno-deprecated-declarations"] + cflags + [GUI_SOURCE, "-o", GUI_BINARY] + ldflags
        ...
        print("g++ not found. Install with:  sudo pacman -S gcc")
        return False
    except Exception as e:
